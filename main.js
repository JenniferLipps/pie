...
//   };
  mbts.forEach((pie) => {
    ...
    domString += `<img src=${pie.imageUrl} class="pieImage" alt='Image of ${pie.name}.'>`
    domString += '</div>';
  })
...
const buttonClick = (e) => {
  ...
  // once we have all the pies for that instructor - print: call pieBuilder
  const selectedPies = [];
  pies.forEach((pie) => {
